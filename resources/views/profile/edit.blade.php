@extends('layouts.app')
@section('title', 'Profil Saya - Sahata Cosmetic')
        ...
        <div class="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                ...
                <div class="flex items-center gap-5">
                    <div
                        class="w-20 h-20 rounded-full overflow-hidden bg-gradient-to-br from-primary-400 to-accent-400 flex items-center justify-center text-white text-2xl font-bold flex-shrink-0">
                        @if($user->avatar)
                ...
                <p class="text-sm font-medium text-gray-700">Ganti Password <span class="text-gray-400">(kosongkan jika
                        tidak ingin mengubah)</span></p>
