@extends('layouts.app')
@section('title', 'Daftar - GlowUp Beauty')
...
<div class="min-h-[80vh] flex items-center justify-center py-12 px-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 text-sm mt-1">Bergabung dengan GlowUp Beauty</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-pink-100 p-8">
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div>
                    <label for="phone" class="block text-sm font-medium text-gray-700 mb-1.5">No. Telepon <span class="text-gray-400">(opsional)</span></label>
